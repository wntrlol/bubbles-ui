...
export default function SearchClient() {
  ...
  return (
    <div className="mx-auto max-w-page px-4 pb-16 pt-28 sm:px-6 lg:pt-32">
      ...
      <div className="glass mt-6 flex items-center gap-3 rounded-full px-5 py-3 focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-primary">
        ...
        <input
          ...
          spellCheck={false}
          enterKeyHint="search"
          className="w-full bg-transparent text-body-lg text-white placeholder:text-muted focus:outline-none"
        />
            ...
            <button
              ...
              className={cn(
                ...
                filter === f.value
                  ...
                  : "border-outline bg-[rgba(60,50,79,0.55)] text-muted hover:text-white",
              )}
            >
              {f.label}
